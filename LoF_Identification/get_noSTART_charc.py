...
for sample in l_samples:
	f_nostart = open("/N/slate/pjohri/Paramecium/CNSGenomes/my_consensus_noSTART_VCF/" + sample + "_homo.fasta", 'r')
	for line in f_nostart:
		line1 = line.strip('\n')
		if line1[0] == ">":
			gene = line1[1:]
			try:
...
result = open("/N/slate/pjohri/Paramecium/CNSGenomes/noSTART_analysis/" + species + "_noSTART_genes.char", 'w+')
